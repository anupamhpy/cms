...
class LeftSidebar extends Component {
    render() {
        return (
            <div className="sidebar s1 collapsed" data-position="left" data-layout="col-3cm" data-sb-id="s1" style={{ "transform": "translateZ(0px)" }}>
                <a className="sidebar-toggle" title="Expand Sidebar" style={{ "transform": "translate(0px, 0px)" }}>
                    <i className="fas icon-sidebar-toggle"></i></a>
                <div className="sidebar-content" style={{ "transform": "translate(0px, 0px)" }}>
                    <div className="sidebar-top group">
                        <p>Follow:</p>
                        <ul className="social-links">
                            <li><a rel="nofollow" className="social-tooltip"
                    ...
                    <div id="recent-posts-widget-with-thumbnails-11" className="widget recent-posts-widget-with-thumbnails">
                        <div id="rpwwt-recent-posts-widget-with-thumbnails-11"
                            className="rpwwt-widget">
                            <h3 className="widget-title">नई पोस्ट</h3>
                            <ul>
                                <li><a href="http://www.hindiagate.com/diwali-par-tranditioal-nahi-indo-western-dress-se-dijiye-khud-ko-new-look/"><img
                                    ...
                                    className="attachment-125x77 size-125x77 wp-post-image"
                                    alt=""
                                ...
                                <li><a href="http://www.hindiagate.com/diwali-ke-pradushan-se-khud-ko-kaise-bacchye/"><img
                                    ...
                                    sizes="(max-width: 125px) 100vw, 125px" /><span
                                        className="rpwwt-post-title">दिवाली
                                        के
                                        पटाखे न
                                        पहुंचाए
                                        सेहत को
                                ...
                                <li><a href="http://www.hindiagate.com/kela-aapki-neend-ko-achi-bannae-main-madad-kar-sakta-hai/"><img
                                    ...
                                    className="attachment-125x77 size-125x77 wp-post-image"
                                    alt="" /><span
                                        className="rpwwt-post-title">Bad
                                        नींद को
                                        Good
                                        बनाएगा
                                        केला,
